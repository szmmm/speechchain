...
resume=/data/mifs_scratch/mjfg/zs323/yr4project/speechchain/egs/babel/asrtts/exp/tts_EN/results/snapshot.ep.200        # Resume the training from snapshot
